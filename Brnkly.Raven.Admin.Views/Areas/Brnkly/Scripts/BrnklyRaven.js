$(function () {
    ...
    function RavenConfigVM(data) {
        ...
        self.save = function () {
            $.ajax({
                url: '/brnkly/api/raven/replication/pending',
                type: 'PUT',
        ...
        self.publish = function() {
            $.ajax({
                url: '/brnkly/api/raven/replication/live',
                type: 'PUT',
                data: '"' + self.etag() + '"',
                contentType: "application/json;charset=utf-8",
                beforeSend: function (jqXHR, settings) { $('#working').show(); },
    ...
    function StoreVM(data) {
        ...
        self.getStats = function () {
            $.ajax({
                url: '/brnkly/api/raven/replication/stats',
                type: 'POST',
                data: ko.mapping.toJSON(self),
                contentType: "application/json;charset=utf-8",
                success: function (data) {
        ...
        self.updateTracers = function () {
            $.ajax({
                url: '/brnkly/api/raven/replication/tracers',
                type: 'POST',
                data: ko.mapping.toJSON(self),
                contentType: "application/json;charset=utf-8",
                success: function (data) {
    ...
    function IndexStatsVM(data) {
        ...
        self.paste = function (toInstanceUrl) {
            ...
            $.ajax({
                url: '/brnkly/api/raven/indexing/copy',
                type: 'POST',
                data: ko.toJSON({
        ...
        self.reset = function (instanceUrl) {
            $.ajax({
                url: '/brnkly/api/raven/indexing/reset',
                type: 'POST',
                data: ko.toJSON({
    ...
    function loadRavenConfig() {
        ...
        $.get("/brnkly/api/raven/replication/live", function (data) {
            if (!data) { data = {}; }
            if (!data.stores) { data.stores = []; }

            brnkly.raven = new RavenConfigVM(data);

            $.get("/brnkly/api/raven/replication/pending", function (data) {
